...
public class Program {
    public static void main(String[] args) {
        ...
        ArrayList testSubList1 = (ArrayList) testList.subList(0, 6);
        ArrayList testSubList2 = (ArrayList) testList.subList(3, 5);
        ...
        System.out.println("\tsubList testing");
        LinkedList testSubLinkedList1 = (LinkedList) testLinkedList.subList(0, 9);
        LinkedList testSubLinkedList2 = (LinkedList) testLinkedList.subList(4, 6);
